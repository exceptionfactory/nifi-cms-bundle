...
public class DecryptCMSTest {
    ...
    public void init() throws Exception {
        ...
        Mockito.when(privateKeyService.getIdentifier()).thenReturn(KEY_SERVICE_ID);
        ...
        certificate = CertificateBuilder.generateCertificate(keyPair);
    }
    ...
    public void testSuccess() throws Exception {
        ...
        Mockito.when(privateKeyService.findPrivateKey(any(), any())).thenReturn(privateKey);
